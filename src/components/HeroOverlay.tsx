...
export function HeroOverlay({ children, className }: HeroOverlayProps) {
  ...
  React.useEffect(() => {
    ...
    if (prefersReducedMotion) {
      // For reduced motion, just check if in viewport (no animation)
    ...
    const observer = new IntersectionObserver(
      ([entry]) => {
        ...
        // Start fading when ratio drops below 0.8, complete fade at 0.2
        const fadeStart = 0.8
        const fadeEnd = 0.2
      ...
      {
        // 21 thresholds for smooth fade (better granularity)
        threshold: Array.from({ length: 21 }, (_, i) => i / 20),
        // Start fading when 10% of element has scrolled off top
      ...
      >
        ...
        {mounted && (
          <div
            ...
            style={{
              backgroundImage: `url("data:image/svg+xml,%3Csvg viewBox='0 0 400 400' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='heroNoise'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='3' numOctaves='3' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23heroNoise)'/%3E%3C/svg%3E")`,
